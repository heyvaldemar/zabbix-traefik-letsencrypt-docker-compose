#!/bin/bash
# End-to-end tests for the zabbix-traefik-letsencrypt-docker-compose backup + restore flow.
#
...
COMPOSE_PROJECT_NAME="${COMPOSE_PROJECT_NAME:-zabbix}"
DOCKER_COMPOSE_FILE="${DOCKER_COMPOSE_FILE:-zabbix-traefik-letsencrypt-docker-compose.yml}"
...
BACKUPS_PATH="${ZABBIX_POSTGRES_BACKUPS_PATH%/}"
BACKUP_PREFIX="${ZABBIX_POSTGRES_BACKUP_NAME}"
BACKUP_EXT=".gz"
INTERVAL="${ZABBIX_BACKUP_INTERVAL}"
